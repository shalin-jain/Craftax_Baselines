# Copied and minimally modified from https://github.com/tinkoff-ai/sac-rnd
...
class RunningMeanStd:
    ...
    def normalize(self, batch, eps=1e-8) -> jax.Array:
        return (batch - self.state["mean"]) / (jnp.sqrt(self.state["var"]) + eps)
